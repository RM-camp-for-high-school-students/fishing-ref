...
export default function GameOverviewCard() {
  ...
  const {isConnected, gameStatus, gameCountdown, currentStage, stageCountdown} = socketContent
      ...
      <CardContent>
        <div className={"flex justify-between"}>
          <div className={"flex-col space-y-1"}>
            ...
            <div
              className={`${gameStatus === "running" || gameStatus === "pause" || gameStatus === "end" ? "text-5xl font-bold" : "text-5xl font-bold text-gray-500"}`}>
              {gameStatus === "running" || gameStatus === "pause" || gameStatus === "end" ? gameStatusLocalization(gameStatus) : "未开始"}
            </div>
          </div>
          <div className={"flex-col space-y-1"}>
            ...
            <div
              className={`${gameStatus === "running" || gameStatus === "pause" || gameStatus === "end" ? "text-5xl font-bold" : "text-5xl font-bold text-gray-500"}`}>
              {gameStatus === "running" || gameStatus === "pause" || gameStatus === "end" ? secondsToTimerFormat(gameCountdown) : "未开始"}
            </div>
          </div>
          <div className={"flex-col space-y-1"}>
            ...
            <div
              className={`${gameStatus === "running" || gameStatus === "pause" || gameStatus === "end" ? "text-5xl font-bold" : "text-5xl font-bold text-gray-500"}`}>
              {gameStatus === "running" || gameStatus === "pause" || gameStatus === "end" ? currentStageLocalization(currentStage) : "未开始"}
            </div>
          </div>
          <div className={"flex-col space-y-1"}>
            ...
            <div
              className={`${gameStatus === "running" || gameStatus === "pause" || gameStatus === "end" ? "text-5xl font-bold" : "text-5xl font-bold text-gray-500"}`}>
              {gameStatus === "running" || gameStatus === "pause" || gameStatus === "end" ? secondsToTimerFormat(stageCountdown) : "未开始"}
            </div>
          </div>
        </div>
      </CardContent>
